...
# [input("Enter your Email: ").strip()] is used for to remove unnecessary spaces in the string/email
username = email[:email.index('@')]
#[:email.index('@')] is used to take the characters/letters from 1st to before '@'
domain = email[email.index('@') + 1:]
#[email.index('@') + 1:] is used to take the characters/letters till the last one from the letter which is after '@'
